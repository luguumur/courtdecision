...
public class ComponentPermissionSelectionModel extends AbstractSelectModel implements
		Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1720008455645039825L;
	...
	public ComponentPermissionSelectionModel(CoreDAO cdao) {
		List<Permission> list = cdao.getComponentPermissionList();
