...
public class AppointmentSelectionModel extends AbstractSelectModel implements
		Serializable {
	...
	public AppointmentSelectionModel(CoreDAO cdao,AppointmentType type, AppointmentSortEmployee sort) {
		List<Appointment> list = cdao.getListAppointment(type,sort);
