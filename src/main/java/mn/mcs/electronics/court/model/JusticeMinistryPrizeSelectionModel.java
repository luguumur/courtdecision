...
public class JusticeMinistryPrizeSelectionModel extends AbstractSelectModel implements Serializable {
	...
	public JusticeMinistryPrizeSelectionModel(CoreDAO cdao) {
		List<Award> list = cdao.getListAward(AwardType.JUSTICE_MINISTRYPRIZE);
