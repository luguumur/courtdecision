...
public class DegreeTypeOfEducationDoctorSelectionModel extends AbstractSelectModel implements
		Serializable {
	...
	private Comparator<DegreeTypeOfEducationDoctor> empComparator = new Comparator<DegreeTypeOfEducationDoctor>() {

		public int compare(DegreeTypeOfEducationDoctor o1, DegreeTypeOfEducationDoctor o2) {
	...
	public DegreeTypeOfEducationDoctorSelectionModel(CoreDAO cdao) {
		List<DegreeTypeOfEducationDoctor> list = cdao.getListEducationDoctor();
	...
	private void setLists(List<DegreeTypeOfEducationDoctor> list, boolean preSurname) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			DegreeTypeOfEducationDoctor value = (DegreeTypeOfEducationDoctor) list.get(i);
