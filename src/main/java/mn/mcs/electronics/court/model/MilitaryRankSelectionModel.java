...
public class MilitaryRankSelectionModel extends AbstractSelectModel implements
		Serializable {
	...
	public MilitaryRankSelectionModel(CoreDAO cdao, MilitaryRankType type) {
		List<MilitaryRank> list = cdao.getListMilitaryByType(type);
