...
public class StatePrizeSelectionModel extends AbstractSelectModel implements
		Serializable {
	...
	public StatePrizeSelectionModel(CoreDAO cdao, AwardType awardType) {
		List<Award> list = cdao.getListAward(awardType);
