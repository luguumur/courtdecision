...
public class EmployeeOrgSelectionModel extends AbstractSelectModel implements
		Serializable {
	...
	public EmployeeOrgSelectionModel(CoreDAO cdao, Organization org) {
		List<Employee> list = cdao.getListEmployee(org);
