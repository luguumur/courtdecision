...
public class PageEmployeeAtTraining {
	...
	void initGrid() {
		// Сургалтанд байгаа ажилчдын жагсаалт
		bean.setVacationType(dao.getVacationTypeByName("Сургалт"));
		bean.setChuluuDuusahOgnooSurgalt(new Date());
