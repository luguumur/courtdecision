...
public class PageEmployeePregnant {
	...
	void initGrid() {
		// Жирэмсний амралтанд байгаа ажилчдын жагсаалт
		bean.setVacationType(dao.getVacationTypeByName("Жирэмсэний амралт"));
		bean.setChuluuDuusahOgnooJiremsen(new Date());
